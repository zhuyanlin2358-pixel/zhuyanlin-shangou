/**
 * Grainient — WebGL 颗粒渐变背景
 * 来源：https://reactbits.dev/backgrounds/grainient
 * 依赖：ogl（WebGL 轻量封装）
 */
...
// WeakMap 存储每个容器的 WebGL 上下文，避免重复创建
...
export default function Grainient({
  ...
  useEffect(() => {
    ...
    ;(u.uCenterOffset.value as Float32Array)[0] = centerX
    ;(u.uCenterOffset.value as Float32Array)[1] = centerY
    u.uZoom.value           = zoom
