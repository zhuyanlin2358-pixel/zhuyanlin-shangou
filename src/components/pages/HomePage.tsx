  ...
  return (
    <div style={{ minHeight: '100vh', width: '100%', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        {/* ── 两大主入口 ── */}
        <div style={{ display: 'flex', gap: 12, marginBottom: 16, width: 'min(680px, 100%)' }}>
          ...
          >
            ...
            <div style={{ marginTop: 16, display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>
              三列画布编辑器
          ...
          >
            ...
            <div style={{ fontSize: 12, color: 'rgba(0,0,0,0.45)', lineHeight: 1.5 }}>
              N4 文字标签 · N2 品牌 Logo<br />
              一拖四 · Banner · 弹窗
            </div>
            <div style={{ marginTop: 16, display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, color: 'rgba(0,0,0,0.3)' }}>
              素材设计工作室
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5}>
                <path d="M5 12h14M12 5l7 7-7 7"/>
              </svg>
